export default function Privacy() {
  return (
    <div className="relative h-full mx-auto mt-5 prose text-gray-500 max-w-7xl prose-indigo">
      ...
      <p className="py-4">
        ...
        which you can be personally identified. For more detailed information on
        data protection, please refer to our privacy policy listed below this
        text.
        <br /> <br />
        ...
        can be, for example, data that you enter in a contact form. <br />
        ...
        collected automatically as soon as you enter this website. <br />
        <br />
        What do we use your data for? <br />
        Some of the data is collected to ensure error-free provision of the
        website. Other data may be used to analyze your user behavior. <br />
        <br />
        ...
        complaint with the competent supervisory authority. <br />
        For this purpose, as well as for further questions on the subject of
        data protection, you can contact us at any time. Analysis tools and
      ...
      <p className="py-4">
        ...
        offer by a professional provider (Art. 6 para. 1 lit. f DSGVO). <br />
        ...
        United States <br />
        <br />
        Conclusion of an order processing contract <br />
      ...
      <p className="py-4">
        ...
        explains how and for what purpose this is done. <br />
        ...
        <br />
        <br />
        Note on the responsible office <br />
        The responsible party for data processing on this website is: <br />
        <br />
        stackOcean GmbH <br />
        Kuhnkestr. 6 <br />
        24118 Kiel <br />
        Phone: +49 431 55682903 <br />
        E-mail: hello@stackocean.com <br />
        <br />
        ...
        of personal data (e.g. names, e-mail addresses or similar). <br />
        Storage period <br />
        ...
        assert a legitimate request for deletion or revoke your consent to data
        ...
        periods under tax or commercial law); in the latter case, the data will
        be deleted once these reasons no longer apply. <br />
        Note on data transfer to the USA <br />
        Among other things, tools from companies based in the USA are integrated
        on our website. If these tools are active, your personal data may be
        transferred to the US servers of the respective companies. We would like
        to point out that the USA is not a safe third country in the sense of EU
        data protection law. US companies are obliged to hand over personal data
        to security authorities without you as a data subject being able to take
        legal action against this. It can therefore not be ruled out that US
        authorities (e.g. intelligence services) process, evaluate and
        permanently store your data located on US servers for monitoring
        ...
        PURPOSE OF DIRECT MARKETING (OBJECTION PURSUANT TO ARTICLE 21 (2) OF THE
        GERMAN DATA PROTECTION ACT). <br />
        <br />
        ...
        the place of the alleged violation. The right of appeal is without
        prejudice to any other administrative or judicial remedy. <br />
        <br />
        Right to data portability <br />
        You have the right to have data that we process automatically on the
        basis of your consent or in performance of a contract handed over to you
        ...
        only be done insofar as it is technically feasible. <br />
        <br />
        ...
        data, you can contact us at any time. <br />
        <br />
        ...
        right to restriction of processing exists in the following cases: <br />
        ...
        defend or assert legal claims, you have the right to request restriction
        of the processing of your personal data instead of erasure. If you have
        lodged an objection pursuant to Art. 21 (1) DSGVO, a balancing of your
        and our interests must be carried out. As long as it has not yet been
        determined whose interests prevail, you have the right to request the
        restriction of the processing of your personal data. <br />
        <br />
        ...
        of the rights of another natural or legal person or for reasons of an
      ...
      <p className="py-4">
        Plausible. <br />
        This website uses the open source web analytics service Plausible. The
        information collected by Plausible about the use of this website is
        stored on our server. The IP address is anonymized before storage.{" "}
        <br />
        With the help of Plausible, we are able to collect and analyze data
        about the use of our website by website visitors. This allows us to find
        out, among other things, when which page views were made and from which
        region they come. We also collect various log files (e.g. IP address,
        referrer, browsers and operating systems used) and can measure whether
        our website visitors perform certain actions (e.g. clicks, purchases and
        the like). <br />
        <br />
        ...
        analysis of user behavior in order to optimize both its website and its
        advertising. Insofar as a corresponding consent has been requested (e.g.
        consent to store cookies), the processing is carried out exclusively on
        the basis of Art. 6 (1) lit. a DSGVO; the consent can be revoked at any
        time. <br />
        <br />
        Hosting <br />
        We host Plausible exclusively on our own servers, so that all analysis
      ...
      <p className="py-4">
        ...
        transfer of data to YouTube partners is not necessarily excluded by the
        extended data protection mode. Thus, YouTube - regardless of whether you
        watch a video - connects to the Google DoubleClick network. <br />
        <br />
        As soon as you start a YouTube video on this website, a connection to
        the YouTube servers is established. This tells the YouTube server which
        of our pages you have visited. If you are logged into your YouTube
        account, you enable YouTube to assign your surfing behavior directly to
        your personal profile. You can prevent this by logging out of your
        YouTube account. <br />
        Furthermore, YouTube can save various cookies on your end device after
        ...
        visitors to this website. This information is used, among other things,
        to collect video statistics, improve the user experience, and prevent
        fraud attempts. <br />
        If necessary, further data processing operations may be triggered after
        the start of a YouTube video, over which we have no control. <br />
        YouTube is used in the interest of an appealing presentation of our
        online offers. This represents a legitimate interest within the meaning
        of Art. 6 para. 1 lit. f DSGVO. Insofar as a corresponding consent has
        been requested, the processing is carried out exclusively on the basis
        of Art. 6 para. 1 lit. a DSGVO; the consent can be revoked at any time.{" "}
        <br />
